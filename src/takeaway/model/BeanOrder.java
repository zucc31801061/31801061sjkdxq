...
public class BeanOrder {
	...
	public static final String[] tableTitles1={"ÉÌ¼Ò±àºÅ","ÆïÊÖ±àºÅ","¶©µ¥×´Ì¬","Âú¼õ±àºÅ","ÓÅ»İÈ¯±àºÅ","Ô­Ê¼½ğ¶î","½áËã½ğ¶î"};
	public static final String[] tableTitles2={"ÓÃ»§±àºÅ","ÉÌ¼Ò±àºÅ","¶©µ¥×´Ì¬","Âú¼õ±àºÅ","ÓÅ»İÈ¯±àºÅ","Ô­Ê¼½ğ¶î","½áËã½ğ¶î"};
